...
export default function ExamplePage() {
  const example = {
    ...
    content: (<>
      ...
      <h2>Theoretical Frameworks on Leadership and Change</h2>
      ...
      <h2>Practical Implications of Leadership in Change Management</h2>
      ...
      <h2>Challenges Faced by Leaders in Change Initiatives</h2>
      ...
      <h2>Emerging Trends in Leadership for Organizational Change</h2>
