...
title:'RRL Example | Experiential Marketing and Consumer Engagement: A rrl on Marketing',
 ...
 const example = {
    ...
    content: (
      <>
        ...
        <p>Pine, B. J., et al. (2016). The New Science of Customer Emotions: Using Emotional Drivers to Transform Your Customer Experience. Journal of Marketing Insights, 2(1), 45-60.</p>
        <p>Schmitt, B. (1999). Experiential Marketing. Journal of Marketing Management, 15(1), 53-67.</p>
        <p>Thompson, G. M., et al. (2005). Consumer-Brand Relationships: Theory and Practice. Journal of Consumer Psychology, 15(3), 222-238.</p>
      </>
    )
  }
  return (
